...
<?php
	...
	if(mysqli_num_rows($cresult)==0){
		...
		$query="INSERT INTO student(name,email,contact,password,cgpa,sapid,dept) VALUES('{$name}','{$email}','{$contact}','{$password}','{$cgpa}','{$sapid}','{$dept}')";
...
<html lang="en">
	...
	<body class="light-gray-bg">
		...
		<div class="templatemo-content-widget templatemo-login-widget templatemo-register-widget white-bg">
			<p>Have an Account? <strong><a href="login1.php" class="blue-text">Sign in here!</a></strong></p>
		</div>
		<!--footer-->
